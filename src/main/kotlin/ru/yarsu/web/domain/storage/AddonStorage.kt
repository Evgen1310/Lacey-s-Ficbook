...
import ru.yarsu.web.users.UserInfo
...
class AddonStorage(
    ...
    fun checkForm(form: String, ignore: String? = null): Boolean {
        val newForms = formsVals.toList().toMutableList()
        newForms.remove(ignore)
        return form in newForms
    }

    fun checkGenre(genre: String, ignore: String? = null): Boolean {
    ...
    fun changeForm(id: Int, newForm: String) {
    ...
    fun changeGenre(id: Int, newGenre: String) {
    ...
    fun createArticleWithData(article: Article, userStorage: UserStorage, addonStorage: AddonStorage): ArticleWithData {
