...
import ru.yarsu.web.models.FormDeleteVM

class FormDeleteHandler(private val htmlView: ContextAwareViewRender, private val dataBaseController: DataBaseController) :
    HttpHandler {
            ...
            ?.let { id ->
                dataBaseController.getFormById(id)
                    .let { formArt ->
                        ...
                        val viewModel = FormDeleteVM(formArt.form)
